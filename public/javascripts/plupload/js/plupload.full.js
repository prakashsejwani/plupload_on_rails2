    ...
    c.runtimes.Gears = c.addRuntime("gears", {
        ...
        init: function (j, l) {
            ...
            j.bind("PostInit", function () {
                var n = j.settings,
                    m = b.getElementById(n.drop_element);
                if (m) {
            ...
            j.bind("UploadFile", function (s, p) {
                ...
                function n() {
                    var z, B, w = s.settings.multipart,
                        v = 0,
                        A = {
                    ...
                    function y(D) {
                        var C, I = "----pluploadboundary" + c.guid(),
                            F = "--",
                            H = "\r\n",
                            E, G;
                        if (w) {
    ...
    b.runtimes.Html4 = b.addRuntime("html4", {
        ...
        init: function (f, g) {
            f.bind("Init", function (p) {
                ...
                p.bind("Refresh", function (B) {
                    var G, C, D, E, y, H, I, F, A;
                    G = e(B.settings.browse_button);
                    if (G) {
                        y = b.getPos(G, e(B.settings.container));
                        H = b.getSize(G);
                        I = e("form_" + q);
                        F = e("input_" + q);
                        b.extend(I.style, {
                        ...
                        if (B.features.canOpenDialog) {
                            A = parseInt(G.parentNode.style.zIndex, 10);
                            if (isNaN(A)) {
                                A = 0
                            }
                            b.extend(G.style, {
                        ...
                        C = B.features.canOpenDialog ? G : I;
                        if (D) {
                            b.addEvent(C, "mouseover", function () {
                                b.addClass(G, D)
                            }, B.id);
                            b.addEvent(C, "mouseout", function () {
                                b.removeClass(G, D)
                            }, B.id)
                        }
                        if (E) {
                            b.addEvent(C, "mousedown", function () {
                                b.addClass(G, E)
                            }, B.id);
